...
interface GeneralQueryNodeData {
  label: string;
  description: string;
  inputs: string[];
  outputs: string[];
...
interface GeneralQueryNodeProps {
  data: GeneralQueryNodeData;
}

export const GeneralQueryNode: React.FC<GeneralQueryNodeProps> = ({ data }) => {
